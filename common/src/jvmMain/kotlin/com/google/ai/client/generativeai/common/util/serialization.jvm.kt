 ...
 */
internal actual fun <T : Enum<T>> T.serialName(): String =
  declaringJavaClass.getField(name).getAnnotation<SerialName>()?.value ?: name
 ...
 */
internal actual fun <T : Enum<T>> KClass<T>.enumValues(): Array<T> =
