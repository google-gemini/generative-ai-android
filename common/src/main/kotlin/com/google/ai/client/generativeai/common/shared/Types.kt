...
object HarmCategorySerializer : KSerializer<HarmCategory?> by enumSerializer<HarmCategory>()
...
@Serializable
data class Blob(@SerialName("mime_type") val mimeType: String, val data: Base64)
...
enum class HarmBlockMethod {
    @SerialName("HARM_BLOCK_METHOD_UNSPECIFIED")
    UNSPECIFIED,
    SEVERITY,
    PROBABILITY,
}
