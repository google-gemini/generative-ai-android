...
To try out the sample app you can direclty import the project from Android Studio 
via **File &rarr; New &rarr; Import Sample** and searching for *Generative AI Sample* or follow these steps below:
